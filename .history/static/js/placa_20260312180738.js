...
// Campos técnicos/inúteis que nunca devem aparecer no HTML nem no copiar relatório
...
const SECOES_PLACA = [
    {
        ...
        campos: ["placa_mercosul", "placa_antiga", "descricaoMarcaModelo", "descricaoCor", "anoFabricacao", "anoModelo", "descricaoTipoVeiculo", "descricaoEspecieVeiculo", "descricaoCarroceria", "descricaoCombustivel", "capacidadePassageiros", "descricaoNacionalidade", "procedencia", "descricaoCategoria", "categoriaMontagem", "linha"]
    },
    {
    ...
    },
    {
        ...
        campos: ["eixos", "codigoCarroceria", "codigoNacionalidade", "codigoSituacao"]
    }
];
...
function renderizarDadosPlaca(dados) {
    ...
    for (const secao of SECOES_PLACA) {
        ...
        for (const campo of secao.campos) {
            if (CAMPOS_IGNORADOS_PLACA.has(campo)) continue;
    ...
    for (const [chave, valor] of Object.entries(dados)) {
        if (CAMPOS_IGNORADOS_PLACA.has(chave)) continue;
